...
window(11,10,55,11);textbackground(0);clrscr();
window(10,10,55,10);textbackground(7);clrscr();
cprintf("\n\tInsuficientes cajas! Quedan: %d",ca1200);getch();cajas2();
}
...
window(11,10,55,11);textbackground(0);clrscr();
window(10,10,55,10);textbackground(7);clrscr();
cprintf("\n\tInsuficientes cajas! Quedan: %d",ca1500);getch();cajas2();
}
...
window(11,10,55,11);textbackground(0);clrscr();
window(10,10,55,10);textbackground(7);clrscr();
cprintf("\n\tInsuficientes cajas! Quedan: %d",ca1800);getch();cajas2();
}
...
window(11,10,55,11);textbackground(0);clrscr();
window(10,10,55,10);textbackground(7);clrscr();
cprintf("Insuficientes pa工elos! Quedan: %d",ca120);getch();sueltos2();
}
...
window(11,10,55,11);textbackground(0);clrscr();
window(10,10,55,10);textbackground(7);clrscr();
cprintf("Insuficientes pa工elos! Quedan. %d",ca150);getch();sueltos2();
}
...
gotoxy(3,4);cprintf("Cantidad: %d",cantidachu);
